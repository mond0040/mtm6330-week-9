...
const rename = require('gulp-rename') // load gulp-rename to rename our js filter
...
// Define a task to concatenate and minify JavaScript
gulp.task('scripts', function () {
  return gulp
    .src('js/*.js') // setting the source files for gulp to work with
